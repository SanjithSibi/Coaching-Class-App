...
class updateStudyMaterials extends StatefulWidget {
  @override
  _updateStudyMaterialsState createState() => _updateStudyMaterialsState();
}

class _updateStudyMaterialsState extends State<updateStudyMaterials> {
  ...
  Future<void> deletePdf(String pdfId, String fileName) async {
    await _firebaseFirestore.collection("pdf").doc(pdfId).delete();
